...
PKG_VERSION="53c20cd18c57bdc4f39ff0aba6dc7510dc57045f"
PKG_SHA256="e49729b2b7573a8d3b053fbed2ac6b3d58bd434f18494d9e3d99b0bdf2f1a130"
PKG_ARCH="any"
PKG_LICENSE="GPLv2"
...
makeinstall_target() {
  ...
  if [ "${DEVICE}" = "RG351P" ]; then
    ...
    #FIXME - add device specific config
    cp ${PKG_DIR}/config/mupen64plus-RG351MP.cfg ${INSTALL}/usr/local/share/mupen64plus/mupen64plus.cfg
