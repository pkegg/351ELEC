...
RG351_CONTROLLER_DEVICE='/dev/input/event3' # Joystick events (for Fn key) #TODO: use proper controller for RG351MP
...
V_FUNC_KEY_EVENT='*(BTN_TR2), value *' # Matches all RG351V Fn key events #TODO: Update function key for RG351MP
